...
var todoApp = function () {
  ...
  */
  ...
  function saveEditTask(event){
    ...
    var editTaskElement = document.getElementById('details_'+taskId);
    var newTaskDetails = editTaskElement.innerHTML;

    if(newTaskDetails) {
      selectedTask.setTaskDetails(newTaskDetails);
      editTaskElement.innerHTML = newTaskDetails;

      editTaskElement.setAttribute('contentEditable', 'false')
    }
  }
